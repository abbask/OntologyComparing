...
--
-- Host: localhost:3306
-- Generation Time: Aug 16, 2019 at 05:52 AM
...
--
-- Table structure for table `property_restriction`
--

DROP TABLE IF EXISTS `property_restriction`;
...
--
-- Table structure for table `property_restriction_class`
--

DROP TABLE IF EXISTS `property_restriction_class`;
CREATE TABLE `property_restriction_class` (
  `ID` int(11) NOT NULL,
  `property_restriction_id` int(11) NOT NULL,
...
--
-- Indexes for table `property_restriction`
--
ALTER TABLE `property_restriction`
  ADD PRIMARY KEY (`ID`);

--
-- Indexes for table `property_restriction_class`
--
ALTER TABLE `property_restriction_class`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `property_restriction`
--
ALTER TABLE `property_restriction`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `property_restriction_class`
--
ALTER TABLE `property_restriction_class`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
